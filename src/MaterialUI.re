    ...
    ReasonReact.wrapJsForReason(
      ...
      ~props=
        makeProps(
          ...
          ~collapsedHeight?,
          ~component=?Js.Option.map((. v) => unwrapValue(v), component),
          ~in_=?Js.Option.map((. v) => Js.Boolean.to_js_boolean(v), in_),
          ~onEnter?,
          ~onEntered?,
          ~onEntering?,
          ~onExit?,
    ...
    ReasonReact.wrapJsForReason(
      ...
      ~props=
        makeProps(
          ...
          ~onClose?,
          ~open_=?
            Js.Option.map((. v) => Js.Boolean.to_js_boolean(v), open_),
          ~_PaperProps?,
          ~_SlideProps?,
          ~theme,
          ~transitionDuration=?
...
module TableFooter = {
  ...
  [@bs.obj]
  external makeProps :
    (~component: 'union_0=?, ~style: ReactDOMRe.style=?, unit) => _ =
    "";
  let make =
      (
        ~component:
...
module TablePagination = {
  ...
  external makeProps :
    (
      ...
      ~rowsPerPageOptions: 'arrayGeneric_t=?,
      ~_SelectProps: Js.t({..})=?,
      ~className: string=?,
      ~numeric: Js.boolean=?,
      ~padding: string=?,
