module MaterialUI = {
  ...
  module Badge = {
    ...
    let make =
      ...
      ReasonReact.wrapJsForReason(
        ~reactClass,
        ~props={"badgeContent": badgeContent, "style": from_opt(style)},
        children
      );
  };
  module Button = {
  ...
  module CardActions = {
    [@bs.module "material-ui/CardActions"] external reactClass : ReasonReact.reactClass =
      "default";
    let make = (~disableActionSpacing=?, ~style: option(ReactDOMRe.style)=?, children) =>
      ReasonReact.wrapJsForReason(
        ~reactClass,
        ~props={
          "disableActionSpacing": disableActionSpacing |> unwrapBool,
          "style": from_opt(style)
        },
        children
      );
  ...
  module CardContent = {
    [@bs.module "material-ui/CardContent"] external reactClass : ReasonReact.reactClass =
      "default";
    let make = (~style: option(ReactDOMRe.style)=?, children) =>
      ReasonReact.wrapJsForReason(~reactClass, ~props={"style": from_opt(style)}, children);
  };
  module CardHeader = {
  ...
  module CardMedia = {
    ...
    let make = (~style: option(ReactDOMRe.style)=?, ~image: option(string)=?, children) =>
      ReasonReact.wrapJsForReason(
        ~reactClass,
        ~props={"style": from_opt(style), "image": from_opt(image)},
        children
      );
  };
  module Chip = {
    ...
    let make =
      ...
      ReasonReact.wrapJsForReason(
        ~reactClass,
        ~props={"avatar": from_opt(avatar), "style": from_opt(style), "label": label},
        children
      );
  };
  ...
  module Collapse = {
    ...
    let make = (~expanded: option(bool)=?, ~transitionDuration: option(string)=?, children) =>
      ReasonReact.wrapJsForReason(
        ~reactClass,
        ~props={"in": unwrapBool(expanded), "transitionDuration": from_opt(transitionDuration)},
        children
      );
  };
  module Dialog = {
  ...
  module DialogActions = {
    ...
    let make = (~classes: option(dialogActionsClasses)=?, children) =>
      ReasonReact.wrapJsForReason(~reactClass, ~props={"classes": from_opt(classes)}, children);
  };
  ...
  module DialogTitle = {
    [@bs.module "material-ui/DialogTitle"] external reactClass : ReasonReact.reactClass =
      "default";
    type dialogTitleClasses = {root: option(string)};
    let make =
        (~classes: option(dialogTitleClasses)=?, ~disableTypography: option(bool)=?, children) =>
      ReasonReact.wrapJsForReason(
        ~reactClass,
        ~props={"classes": from_opt(classes), "disableTypography": from_opt(disableTypography)},
        children
      );
  };
  module Divider = {
