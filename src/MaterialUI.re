...
module TableFooter = {
  ...
  [@bs.obj]
  external makeProps :
    (~component: 'union_e=?, ~style: ReactDOMRe.style=?, unit) => _ =
    "";
  let make =
      (
        ~component:
...
module TablePagination = {
  ...
  external makeProps :
    (
      ...
      ~rowsPerPageOptions: 'arrayGeneric_f=?,
      ~_SelectProps: Js.t({..})=?,
      ~className: string=?,
      ~numeric: bool=?,
      ~padding: string=?,
  ...
  let make =
      (
        ...
        ~rowsPerPageOptions: option([ | `ArrayGeneric(array('any_j))])=?,
...
module Tabs = {
  ...
  external makeProps :
    (
      ...
      ~className: string=?,
      ~fullWidth: bool=?,
      ~indicatorColor: 'union_x=?,
      ~onChange: ReasonReact.Callback.t(ReactEventRe.Form.t)=?,
      ~scrollable: bool=?,
      ~scrollButtons: string=?,
      ~_TabScrollButton: 'union_7=?,
      ~textColor: string=?,
      ~theme: Js.t({..}),
      ~value: 'any_1=?,
      ~classes: Js.Dict.t(string)=?,
